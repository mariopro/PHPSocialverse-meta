...
{
    "require": {
        "phpsocialverse/meta": "dev-master"
    }
}
```
...
'providers' => [
    '...',
    'PHPSocialverse\Meta\MetaServiceProvider',
];
```
...
```
php artisan config:publish phpsocialverse/meta
```
...
$Meta = new PHPSocialverse\Meta\Meta($config);
